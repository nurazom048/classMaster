...
class ExamListTabView extends StatefulWidget {
  ...
  @override
  State<ExamListTabView> createState() => _ExamListTabViewState();
}

class _ExamListTabViewState extends State<ExamListTabView> {
  String _selectedDepartment = "Electrical Engineering";
  ...
  @override
  void didUpdateWidget(covariant ExamListTabView oldWidget) {
  ...
  void _syncDepartmentsFromExams() {
    ...
    if (activeDepts.isNotEmpty) {
      ...
      if (!_departments.contains(_selectedDepartment)) {
        _selectedDepartment = activeDepts.first;
      }
    }
  }

  Future<void> _loadSavedDepartments() async {
    final saved = await DepartmentStorageService.getSavedDepartments();
    if (mounted) {
      setState(() {
  ...
  void _showAddNewDepartmentDialog() {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.add_business_rounded, color: Color(0xFF7C3AED)),
              SizedBox(width: 8),
          ...
          content: Column(
            ...
            children: [
              const Text(
                "Enter department name to add to routine choice list:",
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (newDept.isNotEmpty) {
                  ...
                  await DepartmentStorageService.saveDepartment(newDept);
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Icon(Icons.menu_book_rounded, color: widget.theme.primaryColor, size: 24),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.stars_rounded, color: Color(0xFF7C3AED), size: 18),
                        SizedBox(width: 6),
                        Text(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(Icons.engineering_rounded, color: Color(0xFF6D28D9), size: 18),
                    ...
                    const SizedBox(height: 8),
                    Text(
                      (departmentSyllabus != null && departmentSyllabus.isNotEmpty)
                          ? departmentSyllabus
              ...
              children: [
                ...
                PopupMenuButton<String>(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.swap_horiz_rounded, size: 14, color: widget.theme.primaryColor),
                ...
                // + Add Dept Button
                InkWell(
                  onTap: _showAddNewDepartmentDialog,
                  borderRadius: BorderRadius.circular(20),
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                    decoration: BoxDecoration(
        ...
        PopupMenuButton<String>(
          ...
          itemBuilder: (context) {
            return _departments.map((dept) {
              return PopupMenuItem<String>(
                value: dept,
                child: Text(dept, style: const TextStyle(fontWeight: FontWeight.w600)),
              );
            }).toList();
          },
          child: Container(
        ...
        if (widget.exams.isEmpty) ...[
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final String? deptSyllabusText =
                  exam.getDepartmentSyllabus(_selectedDepartment);
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          _buildActionButton(context, statusStr, price: examPrice),
                        ],
                      ),
                    ],
                  ),
  ...
  Widget _buildActionButton(BuildContext context, String status, {double price = 0}) {
