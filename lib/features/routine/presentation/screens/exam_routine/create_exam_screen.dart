...
class _CreateExamScreenState extends ConsumerState<CreateExamScreen> {
  ...
  Future<void> _loadSavedDepartments() async {
    ...
    if (mounted) {
      setState(() {
        _suggestedDepartments = savedDepts;
      });
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 8,
                      children:
                          _suggestedDepartments.map((dept) {
                            final isAdded = _deptEntries.any(
                              (e) =>
                                  e.deptName.toLowerCase() ==
                                  dept.toLowerCase(),
                            );
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            final text = customDeptController.text.trim();
                            if (text.isNotEmpty) {
                              _addDepartmentEntry(text);
                              Navigator.pop(context);
                            }
                          },
