...
class ShowWeekdayWidgets extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    //!provider
    final weekdayListProvider = ref.watch(
      weekdayControllerStateProvider(classId),
    );
    final weekdayController = ref.read(
      weekdayControllerStateProvider(classId).notifier,
    );
