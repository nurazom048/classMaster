...
import 'package:classmate/features/routine_fetures/presentation/screens/class_routine/add_class_screen.dart';
import 'package:classmate/features/routine_fetures/presentation/utils/long_press.dart';

class ClassListTabView extends StatelessWidget {
              ...
              if (totalCount == 0)
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final dayClassItem = dayClasses[index];
                    final String name = dayClassItem.name;
                    final String time =
                        "${DateFormat('hh:mm a').format(dayClassItem.startTime)} – ${DateFormat('hh:mm a').format(dayClassItem.endTime)}";
                    final String room = dayClassItem.room;
                    final String teacher = dayClassItem.instructorName;

                  return InkWell(
                    onLongPress: () {
                      if (dayClassItem != null) {
                        PeriodAlert.logPressClass(
                          context,
                          routineId: dayClassItem.routineId,
                          classId: dayClassItem.id,
                          canModify: canModify,
                        );
                      }
                    },
