...
class SelectDayRow extends ConsumerWidget {
  ...
  SelectDayRow({super.key, required this.selectedDay, required this.routineId});

  final List dayNAme = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final selectedDaysNotifier = ref.read(
