      ...
      return CupertinoActionSheet(
        ...
        actions: <Widget>[
          statusProvider.when(
            data: (data) {
              final String save =
                  data.isSummarySaved == true ? "saved " : "add to save ";
                ...
                children: [
                  CupertinoActionSheetAction(
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(save, style: const TextStyle(color: Colors.black)),
                        Icon(saveIc),
                      ],
                    ),
                    onPressed: () {
                      if (data.isSummarySaved == true) {
                        statusNotifier.unsaveSummary(parentContext, summaryID);
                      } else {
                        statusNotifier.saveSummary(parentContext, summaryID);
                      }
                    },
                  ),
